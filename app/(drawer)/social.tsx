        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.postCard}>
            ...
            <Text style={styles.postText}>
              Be stronger and wiser try it again and you will be successful in
              life.
            </Text>
            ...
            <View style={styles.actions}>
              <TouchableOpacity style={styles.actionItem}>
                <Feather name="heart" size={18} color="#444" />
                <Text style={styles.actionText}>3</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.actionItem}>
                <Feather name="message-circle" size={18} color="#444" />
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.actionItem}>
                <Feather name="repeat" size={18} color="#444" />
